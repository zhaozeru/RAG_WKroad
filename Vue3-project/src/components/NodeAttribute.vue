<template>
  <div ref="nodeAttributes" class="node-attributes">
    <h4>节点信息展示:</h4>
...
const scrollToTop = () => {
  if (nodeAttributes.value) {
    nodeAttributes.value.scrollTop = 0
  }
}
</script>
